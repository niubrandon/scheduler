...
storiesOf("Button", module)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Edit", () => <Form student="Lydia Miller-Jones" interviewer={interviewer} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
